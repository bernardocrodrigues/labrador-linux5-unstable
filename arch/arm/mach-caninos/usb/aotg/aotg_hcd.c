...
void aotg_hub_hotplug_timer(struct timer_list * t)
{
	struct aotg_hcd * acthcd = from_timer(acthcd, t, hotplug_timer);
...
void aotg_check_trb_timer(struct timer_list * t)
{
	...
	struct aotg_hcd *acthcd = from_timer(acthcd, t, check_trb_timer);
...
void aotg_hub_trans_wait_timer(struct timer_list * t)
{
	...
	struct aotg_hcd *acthcd = from_timer(acthcd, t, trans_wait_timer);
